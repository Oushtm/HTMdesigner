...
export default function SideBar(props) {
    ...
    return (
        <>
            <div className={(props.hide ? " -translate-x-full " : "") + " absolute transform duration-300 select-none z-40 left-0 top-0 h-full pt-7 w-auto flex flex-col justify-start items-center border-white border-opacity-10 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm"}>
                {
                    (
...
export function AllApps(props) {
    ...
    return (
        <div
            className={`w-10 h-10 rounded m-1 hover:bg-white hover:bg-opacity-20 flex items-center justify-center`}
            ...
            <div className="relative">
                ...
                <div
                    className={
                        ...
                        " w-max py-0.5 px-1.5 absolute top-1 left-full ml-5 text-white text-opacity-90 text-sm bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm border-white border border-opacity-20 rounded-md"
                    }
                >
                    Show Applications
                </div>
