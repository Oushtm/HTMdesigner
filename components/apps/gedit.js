...
export class Gedit extends Component {
    ...
    componentDidMount() {
        ...
        emailjs.init('XxDuAgZHOE5q2RnOX');
    }
    ...
    sendMessage = async () => {
        ...
        // User's EmailJS service and template IDs
        const serviceID = 'service_4co2v1t';
        const templateID = 'template_tc71gfa';
        const templateParams = {
            'name': name,
            'subject': subject,
            'message': message,
            'to_email': 'oussamahatimofficiel@gmail.com' // The email address messages will be sent to
        }
    ...
    render() {
        return (
            <div className="w-full h-full relative flex flex-col bg-ub-cool-grey text-white select-none">
                ...
                <div className="px-2 py-1 bg-ub-gedit-darker text-white text-xs">
                    <p>You can also reach me directly at:</p>
                    <p>• Email: <a href="mailto:oussamahatimofficiel@gmail.com" className="text-blue-300 hover:underline">oussamahatimofficiel@gmail.com</a></p>
                    <p>• LinkedIn: <a href="https://www.linkedin.com/in/oussamahatim/" target="_blank" rel="noreferrer" className="text-blue-300 hover:underline">linkedin.com/in/oussamahatim</a></p>
                </div>
