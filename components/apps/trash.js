...
export class Trash extends Component {
    constructor() {
        ...
        this.trashItems = [
            {
                name: "comic-sans.ttf",
                icon: "./themes/filetypes/font.png"
            },
            {
            ...
            {
                name: "logo-v47-FINAL.psd",
                icon: "./themes/filetypes/psd.png"
            },
            {
                name: "logo-v47-FINAL-FINAL.psd",
                icon: "./themes/filetypes/psd.png"
            },
            {
                name: "logo-v47-FINAL-REALLY-FINAL.psd",
                icon: "./themes/filetypes/psd.png"
            },
            {
                name: "stock-watermarked.jpg",
                icon: "./themes/filetypes/jpg.png"
            },
            {
                name: "make-it-pop.txt",
                icon: "./themes/filetypes/txt.png"
            },
            {
                name: "add-more-white-space.txt",
                icon: "./themes/filetypes/txt.png"
            },
